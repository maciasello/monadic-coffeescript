...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Monadic')],
    Monadic: [
      o('MONADIC Value MonadicBlock', function() {
        return yy.createMonadic($2, $3);
      })
    ],
    MonadicBlock: [
      o('INDENT MonadicBody OUTDENT', function() {
        return $2;
      })
    ],
    MonadicBody: [
      o('MonadicLine', function() {
        return [$1];
      }), o('MonadicBody TERMINATOR MonadicLine', function() {
        $1.push($3);
        return $1;
      }), o('MonadicBody TERMINATOR')
    ],
    MonadicLine: [
      o('PARAM_START ParamList PARAM_END <-- Expression', function() {
        return yy.createBinderLine($2, $5, 'func');
      }), o('PARAM_START ParamList PARAM_END <== Expression', function() {
        return yy.createBinderLine($2, $5, 'boundfunc');
      }), o('Expression', function() {
        return yy.createExpressionLine($1);
      })
    ],
    Block: [
