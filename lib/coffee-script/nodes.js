...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, createBindCall, createCall, createCallback, createLambdaAndBind, del, ends, extend, flatten, fragmentsToText, isComplexOrAssignable, isLiteralArguments, isLiteralThis, locationDataToString, merge, multident, parseNum, ref1, ref2, some, starts, throwSyntaxError, unfoldSoak, utility,
  ...
  createCall = function(monad, args, methodName) {
    var u;
  ...
  createCallback = function(monadicLine, block) {
    var callback, params, ref3;
    params = (ref3 = monadicLine.params) != null ? ref3 : [];
    return callback = new Code(params, Block.wrap([block]), monadicLine.funcGlyph);
  };

  createLambdaAndBind = function(monad, monadicLine, block) {
    var callback;
    callback = createCallback(monadicLine, block);
    return createBindCall(monad, monadicLine.val, callback);
  };
